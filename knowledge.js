    ...
    categories: [
            ...
            items: [
                ...
                },
                {
                    ...
                    details: [
                        ...
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "【Windows 10/11 MTU 查找与修改】",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "【方法一：图形界面法】",
                        "1. 右键开始菜单 → 设置 → 网络和Internet",
                        "2. 选择当前网络类型（以太网/Wi-Fi）→ 硬件属性",
                        "3. 记住物理地址（MAC）用于确认适配器",
                        "4. 按 Win+R，输入 ncpa.cpl 打开网络连接",
                        "5. 右键对应适配器 → 属性 → 双击 TCP/IPv4",
                        "6. 先勾选「使用下面的IP地址」手动设置IP/子网/网关",
                        "7. 点击「高级」→ 取消勾选「自动获取MTU值」",
                        "8. 点击「添加」输入MTU值（如1480、1492）→ 确定",
                        "9. 重启网络连接生效",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "【方法二：命令行法】",
                        "1. Win+R → cmd → 右键以管理员身份运行",
                        "2. 查询MTU：netsh interface ipv4 show subinterfaces",
                        "3. 修改MTU命令：",
                        "   netsh interface ipv4 set subinterface \"适配器名称\" mtu=目标值 store=persistent",
                        "4. 示例：netsh interface ipv4 set subinterface \"以太网\" mtu=1480 store=persistent",
                        "5. 显示「确定」即修改成功，无需重启"
                    ],
        ...
        },
        {
            ...
            items: [
                ...
                {
                    term: "Git Push失败排查",
                    fullForm: "Git Push Failure Troubleshooting",
                    description: "Git推送失败是常见问题，可能由网络连接、代理配置、SSH配置等多种原因导致。以下是系统化的排查流程和解决方案。",
                    details: [
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "【常见错误及解决方案】",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "错误1: 'Failed to connect to github.com port 443'",
                        "原因: 直连443端口失败，需要通过代理访问",
                        "解决: git config --global http.proxy socks5h://127.0.0.1:7890",
                        "",
                        "错误2: 'Could not read from remote repository' (SSH)",
                        "原因: SSH直连被防火墙阻止",
                        "解决: 改用HTTPS + 代理，或尝试ssh.github.com:443",
                        "",
                        "错误3: 'kex_exchange_identification: read: Software caused connection abort'",
                        "原因: SSH连接被阻断，可能是代理不支持SSH协议",
                        "解决: 使用HTTPS方式而非SSH",
                        "",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "【正确配置步骤（推荐）】",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "1. 先确认代理端口: netstat -ano | findstr 'LISTENING'",
                        "2. 设置HTTPS代理:",
                        "   git config --global http.proxy socks5h://127.0.0.1:7890",
                        "   git config --global https.proxy socks5h://127.0.0.1:7890",
                        "3. 改用HTTPS远程: git remote set-url origin https://github.com/用户名/仓库.git",
                        "4. 验证: git push",
                        "",
                        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                        "【SSH代理配置（备用方案）】",
                        ...
                        "注意: 需要安装connect工具或使用nc (netcat)"
                    ],
                    relatedTerms: ["代理服务器", "SSH", "Git配置"]
                }
            ]
        },
        {
